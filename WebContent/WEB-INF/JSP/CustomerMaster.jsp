			...
			<div id="contents">
				<div align="center">
					...
					<form method="POST" action="CustomerRegister">
						郵便番号(半角数字): <input type="text" size="7" id="postNum" name="postNo"><br>

						都道府県： <select id="kenselect" name="ken">
							<option value=""></option>
						...
						</select> 市区町村：<INPUT id="town" type='text' name='shi' size="25" value=''><br>
						番地マンション名など：<INPUT type='text' name='banchi' size="20" value=''><br>
						<INPUT type='submit' name='button' value='登録'><br>
						<br>
					</form>

					<form method="POST" enctype="multipart/form-data"
						action="PostInfoUpload">
						郵便情報CSVファイルアップロード：<br> <input type="file" name="fl" size="20" />
