...
<h1><hr width ="95%">メールテスト<hr width ="95%"> </h1>
<div align="center">

<FORM action='mail'  method="post" >
タイトル：<INPUT type='text' name='TITLE' size="20" value=''><br><br>
本文<br>
<TEXTAREA cols="40" rows="6"  name='MAIL' wrap="hard"></TEXTAREA><br><br>
添付ファイル：　<input type='file' name='FILENAME' size='20' /><br><br>
<INPUT type='submit' name='button' value='メール送信'><br><br>
 </FORM>
