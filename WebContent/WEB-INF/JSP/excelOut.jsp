...
<div id="container">
<div id="main">
<h1><hr width ="95%">納品書出力<hr width ="95%"> </h1>
...
<INPUT type='submit' name='button' value='検索'><br><br>
</FORM>

<FORM action='ProductAdd' method=post>
追加商品ID：<INPUT type='text' name='ADDID' size="5"value=''><br>
追加商品名:<INPUT type='text' name='PNAME' size="8"　value=''><br>
<INPUT type='submit' name='button' value='追加'><br><br>
</FORM>


<FORM action='ProductDelete'  method=post>
商品ID：<INPUT type='text' name='PID' size="1" value='<%= request.getAttribute( "id" )%> '>　<br>
...
商品ID：<INPUT type='text' name='PID' size="1" value='<%= request.getAttribute( "id" )%> 'readonly="readonly">　<br>
商品名：<INPUT type='text' name='PNAME' size="10" value='<%= request.getAttribute( "name" )%> '><br>
<INPUT type='submit' name='button' value='修正'><br><br>
</FORM>
