			...
			<div id="contents">
				<div id="mainContents">
					<div align="right">
						...
						<form>
							商品検索：<br> 商品ID：<input type="text" size="3" id="pid"
								style="text-align: right"><br> <input type="button"
								id="pseach" value="検索" 　onclick="pseach()"> <br>
							<br>
						</form>
...
%>
						...
						<FORM action='CsvOut' method="post">
							CSV出力：<br> ファイル名：<INPUT type='text' name='FILENAME' size="9"
								value=''>.csv<br> <INPUT type='submit'
								name='button' value='Csv出力'><br>
							<br>
						</FORM>
						...
						<FORM action='excel' method=post>
							EXCEL出力：<br> 商品ID：<INPUT type='text' name='PID' id="excelid"
								size="1" value='<%= request.getAttribute( "id" )%>'
								style='text-align: right'> <br> 商品名：<INPUT
								type='text' name='PNAME' id="excelname" size="10"
								value='<%= request.getAttribute( "name" )%>'
								style='text-align: right'><br> 数量：<INPUT
								type='text' name='AMOUNT' size="5" value='10'
								style='text-align: right'><br> 単位：<INPUT
								type='text' name='UNIT' size="5" value='本／冊'
								style='text-align: right'><br> 単価：<INPUT
								type='text' name='UNIPRICE' size="5" value='120'
								style='text-align: right'><br> 金額：<INPUT
								type='text' name='PRICE' size="5" value='1200'
								style='text-align: right'><br> 備考：<INPUT
								type='text' name='MEMO' size="5" value=''
								style='text-align: right'><br> ファイル名：<INPUT
								type='text' name='FILENAME' size="9" value=''>.xlsx<br>

							<INPUT type='submit' name='button' value='excel出力'><br>
							<br>
						</FORM>

						<FORM action='pdf' method=post>
							PDF出力：<br> 商品ID：<INPUT type='text' name='PID' id="pdfid"
								size="1" value='<%= request.getAttribute( "id" )%>'
								style='text-align: right'><br> 商品名：<INPUT
								type='text' name='PNAME' id="pdfname" size="10"
								value='<%= request.getAttribute( "name" )%>'
								style='text-align: right'><br> 数量：<INPUT
								type='text' name='AMOUNT' size="5" value='10'
								style='text-align: right'><br> 単位：<INPUT
								type='text' name='UNIT' size="8" value="本／冊"
								style='text-align: right'><br> 単価：<INPUT
								type='text' name='UNIPRICE' size="5" value='120'
								style='text-align: right'><br> 金額:<INPUT
								type='text' name='PRICE' size="8" value='1200'
								style='text-align: right'><br> 備考：<INPUT
								type='text' name='MEMO' size="5" value=''
								style='text-align: right'><br> ファイル名：<INPUT
								type='text' name='FILENAME' size="9" value=''>.pdf<br>

							<INPUT type='submit' name='button' value='pdf出力'><br>
							<br>
						</FORM>
				...
				<div id="subContents">
					...
					<div align="center">
						<form method="POST" action="ProductMaster">
							商品ID：<INPUT type='text' id="id" name='PID' size="12"
								value='<%= request.getAttribute( "id" )%>' readonly="readonly"
								style="background-color: #F5FFFA; text-align: center"><br>
							商品名：<INPUT type='text' id="pname" name='PID' size="12"
								value='<%= request.getAttribute( "name" )%>' readonly="readonly"
								style="background-color: #F5FFFA; text-align: center">
						</form>
