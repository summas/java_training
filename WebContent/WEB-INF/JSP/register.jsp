			...
			<div id="contents">
				...
				<div align="center">
					...
					<FORM action='register' method=post>
						職員番号：<INPUT type='text' name='ID' value=''><br>
						<br> 職員氏名：<INPUT type='text' name='NAME' value=''><br>
						<br> パスワード：<INPUT type='text' name='PASS' value=''><br>
						<br> 権限：<select name="AUTH" size=1>
							<option value="1">1</option>
							<option value="9">9</option>
						</select> <br>
						<br> <INPUT type='submit' name='button' value='登録'><br>
						<br>
					</FORM>
