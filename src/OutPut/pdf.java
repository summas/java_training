...
public class pdf extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		String buttonNO = request.getParameter("button1");
		...
		name = Sel.select(db.Connect(), product);
		db.close(db.Connect());
...
//			    Row row2 = sheet.createRow(2);
		...
		/**
		 * Cell cell5_0 = row3.getCell(1); Cell cell5_1 = row3.getCell(2); Cell cell5_2
		 * = row3.getCell(3);
		 * 
		 * 
		 **/
		...
		converter.convert(new File(filenameExcel), new File(filenamePdf));
